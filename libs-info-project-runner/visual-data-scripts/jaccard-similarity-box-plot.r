...
libraries <- c("com.alibaba:fastjson", "org.apache.commons:commons-collections4", "commons-io:commons-io", "joda-time:joda-time", "com.h2database:h2",
...
dfToPlot$Library <- factor(dfToPlot$Library, levels=uniqueLibs, labels=getArtifactNames(uniqueLibs))
GPlot1 = ggplot(dfToPlot, aes(x = Library, y=JaccardSim)) + geom_boxplot()  + xlab("") + ylab("Jaccard Similarity") + theme(text = element_text(size=15),
        axis.text.x = element_text(angle=90, hjust=1)) 
ggsave(
  "Documents/Waterloo/PL/21.icse.library-usage/images/jac-sim-box-plot-actual.png",
  plot = GPlot1,
  device = "png")
